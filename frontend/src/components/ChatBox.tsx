...
const ChatBox = ({ isOpen, onClose }: ChatBoxProps) => {
  ...
  return (
    <div className="fixed bottom-20 right-4 w-96 h-[500px] bg-white rounded-xl shadow-2xl animate-slide-up border border-gray-100">
      <div className="flex items-center justify-between bg-gradient-to-r from-medical-primary to-medical-accent text-white p-4 rounded-t-xl">
